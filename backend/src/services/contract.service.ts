    ...
    async createContract(input: CreateContractInput) {
        ...
        return {
            ...
            application: contract.application ? {
                ...
                workExperienceTypes: contract.application.workExperienceTypes,
                ...
                acceptedAt: contract.application.acceptedAt,
                rejectedAt: contract.application.rejectedAt,
                rejectionReason: contract.application.rejectionReason,
                jobPosting: contract.application.jobPosting ? {
                    ...
                    benefits: contract.application.jobPosting.benefits,
                    ...
                    pharmacy: contract.application.jobPosting.pharmacy ? {
                        ...
                        name: contract.application.jobPosting.pharmacy.name,
                        representativeName: contract.application.jobPosting.pharmacy.representativeName,
                        ...
                        businessHours: contract.application.jobPosting.pharmacy.businessHours,
                ...
                pharmacist: contract.application.pharmacist ? {
                    ...
                    yearsOfExperience: contract.application.pharmacist.yearsOfExperience,
                    certificateUrl: contract.application.pharmacist.certificateUrl,
                    certificateStatus: contract.application.pharmacist.certificateStatus,
                    workExperience: contract.application.pharmacist.workExperience,
                    specializations: contract.application.pharmacist.specializations,
