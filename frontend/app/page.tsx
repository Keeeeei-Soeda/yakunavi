...
export default function Home() {
  ...
  const pharmacistBenefits = [
    ...
    },
    {
      ...
      title: '日給が発生する転職活動',
      description: 'おためし期間中も日給が発生。収入を得ながら自分に合う職場を探せます。',
      imagePosition: 'right'
    }
  ];
  ...
  const pharmacyBenefits = [
    ...
    },
    {
      image: '/pharmacy_top-page04.jpg',
      title: '採用コストを大幅削減',
      description: '本採用時の紹介手数料不要。おためし期間の手数料のみで、低コストで優秀な人材を採用できます。',
      imagePosition: 'right'
    }
  ];
            ...
            >
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  { step: '3', icon: '🔍', title: 'おためし案件を探して応募', desc: '条件で絞り込んで気になるおためし案件を見つけ、応募フォームから申し込みます。' },
            ...
            >
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  { step: '3', icon: '📋', title: 'おためし案件票を作成・公開', desc: '勤務日・日給・業務内容を入力しておためし案件を公開。薬剤師から応募が届きます。' },
