  ...
  },
  {
    ...
    content: (
      <div className="space-y-1">
        ...
        <Caution>応募を完了するには資格証明書（薬剤師免許証・保険薬剤師登録票）のアップロードと管理者による承認が必要です。未承認の状態で送信しようとすると、プロフィールでの証明書提出を促すメッセージが表示され、応募は進みません。まずプロフィール画面で書類を提出し、審査完了をお待ちください。</Caution>
